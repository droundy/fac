...
fac.o fac.gcno : fac.c fac.h lib/listset.h lib/iterablehash.h new-build.h
	gcc -Wall -Werror -O2 -std=c11 -g -fprofile-arcs -ftest-coverage -c fac.c

files.o files.gcno : files.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -fprofile-arcs -ftest-coverage -c files.c

targets.o targets.gcno : targets.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -fprofile-arcs -ftest-coverage -c targets.c

clean.o clean.gcno : clean.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -fprofile-arcs -ftest-coverage -c clean.c

new-build.o new-build.gcno : new-build.c fac.h lib/listset.h lib/iterablehash.h new-build.h lib/bigbrother.h lib/arrayset.h
	gcc -Wall -Werror -O2 -std=c11 -g -fprofile-arcs -ftest-coverage -c new-build.c

git.o git.gcno : git.c fac.h lib/listset.h lib/iterablehash.h
