...
fac.o : fac.c fac.h lib/listset.h lib/iterablehash.h new-build.h
	gcc -Wall -Werror -O2 -std=c11 -g -c fac.c

files.o : files.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -c files.c

targets.o : targets.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -c targets.c

clean.o : clean.c fac.h lib/listset.h lib/iterablehash.h
	gcc -Wall -Werror -O2 -std=c11 -g -c clean.c

new-build.o : new-build.c fac.h lib/listset.h lib/iterablehash.h new-build.h lib/bigbrother.h lib/arrayset.h
	gcc -Wall -Werror -O2 -std=c11 -g -c new-build.c

git.o : git.c fac.h lib/listset.h lib/iterablehash.h
