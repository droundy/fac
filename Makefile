...
lib/fileaccesses: lib/fileaccesses.c lib/listset.c lib/bigbrother.c \
	...
	cd lib && gcc -g -O2 -Wall -std=c11 -o fileaccesses fileaccesses.c listset.c bigbrother.c
...
bilge: bilge.c bilge.h targets.c files.c build.c \
       lib/listset.c lib/bigbrother.c lib/syscalls.h
	gcc -lpthread -Wall -std=c11 -g -o bilge bilge.c targets.c files.c build.c lib/listset.c lib/bigbrother.c
